...
//  B00000111, B00000000,
//  B00000000, B00000000,
  0x00, 0x00, 0x00, 0x00, 0x1f, 0xe0, 0x00, 0x2f, 0xe0, 0x00, 0x7f, 0xe0, 0x00, 0x7f, 0xe0, 0x00, 
  0x7f, 0xe0, 0x00, 0x7c, 0x00, 0x00, 0x7c, 0x00, 0x00, 0x7c, 0x00, 0x00, 0xfc, 0x00, 0x43, 0xfc, 
  0x00, 0x67, 0xfc, 0x00, 0x7f, 0xf8, 0x00, 0x3f, 0xf0, 0x00, 0x1f, 0xe0, 0x00, 0x0f, 0xe0, 0x00, 
  0x06, 0xc0, 0x00, 0x04, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};
...
int wall_x[5]; // an array to hold the walls x positions
int wall_y[5]; // an array to hold the walls y positions
int wall_gap = 35; // size of the wall wall_gap in pixels
int wall_width = 8; // width of the wall in pixels
...
void loop() {
  ...
  if (game_state == 0) {
    ...
    outlineTextAtCenter(1, "Royal Club UET");
